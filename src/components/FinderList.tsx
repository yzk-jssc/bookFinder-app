import React, { FunctionComponent, useEffect, useState,MouseEvent, useContext } from "react";
...
const FinderList: FunctionComponent<FinderListProps> = () => {
                ...
                await axiosInstance
                    ...
                    .then((res) =>{
                        ...
                        res.items.map((book) => {
                            ...
                            book_descriptions = book.volumeInfo?.descriptions,
                            ...
                            book_imageLinks = book.volumeInfo.imageLinks?.thumbnail;
    ...
    return (
        <BookItemContext.Provider value={{bookList,visible,bookModalId, bookModalInfo,loading}}>
